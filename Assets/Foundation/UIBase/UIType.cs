...
public class UIType
{
    ...
    public static readonly UIType StarMainMenu = new UIType("View/StarMainMenuView");
     public static readonly UIType StarGameMain = new UIType("View/StarGameMainView");
     public static readonly UIType StarSetting = new UIType("View/StarSettingView");
}
